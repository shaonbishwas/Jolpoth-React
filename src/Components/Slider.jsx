          ...
          <SwiperSlide>
            <div className="w-full relative">
              <img
                ...
                alt=""
              />
              <div class="absolute text-center lg:top-52 w-full px-5 top-[20%] md:top-[30%] lg:px-44 text-white space-y-4 hidden md:block">
                <h1 class="lg:text-6xl font-bold text-2xl">
